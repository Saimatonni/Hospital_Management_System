			...
			<div class="agile-form">
				...
				<div class="row">
                    ...
                    <label class="form-label" style="align:left;"> Full Name 
						...
						<div class="form-input" style="align:left;"><?=$pdtl['patientname']?></div>
					</div>
					<br/>
					 <div class="col-md-12">
                    ...
                    <label class="form-label" style="align:left;"> Email
						...
						<div class="form-input" style="align:left;"><?=$pdtl['mobileno']?></div>
					</div>
					<br/>
					<div class="col-md-12">
                    ...
                    <label class="form-label" style="align:left;"> DOB
						...
						<div class="form-input" style="align:left;"><?=$pdtl['pincode']?></div>
					</div>
					<br/>
				<div class="col-md-12">
                    ...
                    <label class="form-label" style="align:left;"> Address
						...
						<div class="form-input" style="align:left;"><?=$pdtl['address']?></div>
					</div>
					<br/>
